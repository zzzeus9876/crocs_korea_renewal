...
export const useProductStore = create(
    persist((set, get) => ({
        ...
        onMinusCount: (id, color) => {
            ...
            // 보통 reduce를 많이 사용
            // 총금액 계산 + 상태 업데이트 acc는 누적계산
            // const total = updateCart.reduce((acc, item) => {
        ...
        // 주문하기
        onAddOrder: () => {
            const { cartItems, orderList, coupon, selectedCoupon, onFinalPrice, finalPrice } = get()
